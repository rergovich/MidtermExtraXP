...
and one control of your choice. Get these from the user 
(we will assume the user has only 3 debts):  
> monthly car payment
...
Display the answer from the main program (not from the function) 
using a control. 
